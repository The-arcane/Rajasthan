    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Rajasthan Tourism</h3>
            <p className="text-gray-400">
              Discover the magic of India's largest state, where every corner tells a story of valor,
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white">Photo Gallery</a></li>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} Rajasthan Tourism. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
